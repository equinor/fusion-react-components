    ...
    return <div>
        ...
        <div className="spacing-demo-section">
          <div className="spacing-demo-row">
            {PROPORTIONS.map(proportion => <div data-space-proportions={proportion} key={proportion}>
...
```tsx
{
  render: () => <div>
      ...
      <div data-space-proportions="squared" style={{
      maxWidth: '600px',
    ...
    return <div>
        ...
        <div className="spacing-demo-section">
          ...
          <div className="spacing-demo-container">
            {GENERIC_SIZES.map(size => <div key={size} className="spacing-demo-item">
                <div className="spacing-demo-label">
                  data-horizontal-gap=&quot;{size}&quot;
                </div>
                <div data-horizontal-gap={size} className="generic-gap-horizontal">
...
```tsx
{
  render: () => {
    return <div>
        ...
        <div className="spacing-demo-section">
          <div className="spacing-demo-row">
            {PROPORTIONS.map(proportion => <div key={proportion} className="spacing-demo-item" data-space-proportions={proportion}>
                <div className="spacing-demo-label">{proportion}</div>
...
```tsx
{
  render: () => {
    return <div>
        ...
        {DENSITIES.map(density => <div key={density} className="spacing-demo-section">
            <h3>Density: {density}</h3>
            <div data-density={density}>
              {SELECTABLE_SIZES.map(size => <div key={size} className="spacing-demo-container">
                  <h4>Size: {size.toUpperCase()}</h4>
                  <div className="spacing-demo-row">
                    {PROPORTIONS.map(proportion => <div key={proportion} className="spacing-demo-item">
                        <div className="spacing-demo-label">{proportion}</div>
                        <div data-selectable-space={size} data-space-proportions={proportion}>
