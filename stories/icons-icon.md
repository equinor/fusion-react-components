...
|------|------|----------|---------|-------------|
| `title` | `string` | No |  | Title for icon when used semantically |
| `color` | `string` | No | currentColor | Color |
| `name` | `string` | No |  | Name |
| `size` | `16 18 24 32 40 48` | No |  | Size |
| `data` | `IconData` | No |  | Manually specify which icon data to use |
| `rotation` | `0 90 180 270` | No |  | Rotation |
