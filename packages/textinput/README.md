...
`icon`                    | `string`                      | Leading icon to display in input. See [`fusion-react-icon`](https://github.com/equinor/fusion-react-components/tree/main/packages/icon).
`iconTrailing`            | `string`                      | Trailing icon to display in input. See [`fusion-react-icon`](https://github.com/equinor/fusion-react-components/tree/main/packages/icon).
