...
/**
 * Filter defintion for Registering Filters.
 ...
 * @param filterFn(optional) Function that filters data based on the selection. If no supplied, provider will ignore this filter.
