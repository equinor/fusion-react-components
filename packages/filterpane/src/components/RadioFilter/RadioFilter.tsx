...
export const RadioFilter = <TSelections extends Record<string, TSelection>, TData>({
  filter,
  useSearch,
  ...
  return (
    <div className={Styles.RadioFilterContainer} key={'Radio' + title}>
      ...
      {useSearch && (
        <TextInput onInput={onSearchValueChange} value={filterSearch} placeholder={'Search'} type={'search'} />
      )}
