...
.ag-theme-alpine .ag-theme-alpine-fusion textarea[class^=ag-],
.ag-theme-alpine-fusion .ag-theme-alpine textarea[class^=ag-], .ag-theme-alpine input[class^=ag-]:not([type]),
.ag-theme-alpine input[class^=ag-][type=text],
.ag-theme-alpine input[class^=ag-][type=number],
.ag-theme-alpine input[class^=ag-][type=tel],
.ag-theme-alpine input[class^=ag-][type=date],
...
.ag-theme-alpine-fusion .ag-checkbox .ag-input-wrapper,
.ag-theme-alpine-fusion .ag-radio-button .ag-input-wrapper {
  overflow: visible;
}
...
.ag-theme-alpine-fusion textarea[class^=ag-],
.ag-theme-alpine-fusion select[class^=ag-] {
  background-color: #fff;
  background-color: var(--ag-background-color, #fff);
}
.ag-theme-alpine-fusion input[class^=ag-]:not([type]),
.ag-theme-alpine-fusion input[class^=ag-][type=text],
.ag-theme-alpine-fusion input[class^=ag-][type=number],
.ag-theme-alpine-fusion input[class^=ag-][type=tel],
.ag-theme-alpine-fusion input[class^=ag-][type=date],
.ag-theme-alpine-fusion input[class^=ag-][type=datetime-local],
.ag-theme-alpine-fusion textarea[class^=ag-] {
  font-size: inherit;
  line-height: inherit;
  color: inherit;
...
.ag-theme-alpine-fusion input[class^=ag-]:not([type]):disabled,
.ag-theme-alpine-fusion input[class^=ag-][type=text]:disabled,
.ag-theme-alpine-fusion input[class^=ag-][type=number]:disabled,
.ag-theme-alpine-fusion input[class^=ag-][type=tel]:disabled,
.ag-theme-alpine-fusion input[class^=ag-][type=date]:disabled,
.ag-theme-alpine-fusion input[class^=ag-][type=datetime-local]:disabled,
.ag-theme-alpine-fusion textarea[class^=ag-]:disabled {
  color: rgba(24, 29, 31, 0.5);
  color: var(--ag-disabled-foreground-color, rgba(24, 29, 31, 0.5));
  background-color: #f1f2f4;
  background-color: var(--ag-input-disabled-background-color, #f1f2f4);
...
.ag-theme-alpine-fusion input[class^=ag-]:not([type]):focus,
.ag-theme-alpine-fusion input[class^=ag-][type=text]:focus,
.ag-theme-alpine-fusion input[class^=ag-][type=number]:focus,
.ag-theme-alpine-fusion input[class^=ag-][type=tel]:focus,
.ag-theme-alpine-fusion input[class^=ag-][type=date]:focus,
.ag-theme-alpine-fusion input[class^=ag-][type=datetime-local]:focus,
.ag-theme-alpine-fusion textarea[class^=ag-]:focus {
  outline: none;
  box-shadow: 0 0 2px 0.1rem rgba(33, 150, 243, 0.4);
  border-color: rgba(33, 150, 243, 0.4);
  border-color: var(--ag-input-focus-border-color, rgba(33, 150, 243, 0.4));
}
.ag-theme-alpine-fusion input[class^=ag-]:not([type]):invalid,
.ag-theme-alpine-fusion input[class^=ag-][type=text]:invalid,
.ag-theme-alpine-fusion input[class^=ag-][type=number]:invalid,
.ag-theme-alpine-fusion input[class^=ag-][type=tel]:invalid,
.ag-theme-alpine-fusion input[class^=ag-][type=date]:invalid,
.ag-theme-alpine-fusion input[class^=ag-][type=datetime-local]:invalid,
.ag-theme-alpine-fusion textarea[class^=ag-]:invalid {
  border-width: 2px;
  border-style: solid;
  border-color: #e02525;
  border-color: var(--ag-input-border-color-invalid, var(--ag-invalid-color, #e02525));
...
.ag-theme-alpine-fusion .ag-group-expanded,
.ag-theme-alpine-fusion .ag-group-contracted {
  color: #181d1f;
  color: var(--ag-secondary-foreground-color, var(--ag-foreground-color, #181d1f));
}
...
.ag-theme-alpine-fusion .ag-column-select-column-group:not(:last-child),
.ag-theme-alpine-fusion .ag-column-select-column:not(:last-child) {
  margin-bottom: 9px;
}
.ag-theme-alpine-fusion .ag-column-select-column-readonly,
.ag-theme-alpine-fusion .ag-column-select-column-group-readonly {
  color: rgba(24, 29, 31, 0.5);
  color: var(--ag-disabled-foreground-color, rgba(24, 29, 31, 0.5));
  pointer-events: none;
}
...
.ag-theme-alpine-fusion .ag-row-hover {
  background-color: rgba(33, 150, 243, 0.1);
  background-color: var(--ag-row-hover-color, rgba(33, 150, 243, 0.1));
}
...
.ag-theme-alpine-fusion .ag-cell-range-selected:not(.ag-cell-focus),
.ag-theme-alpine-fusion .ag-body-viewport:not(.ag-has-focus) .ag-cell-range-single-cell:not(.ag-cell-inline-editing) {
  background-color: rgba(33, 150, 243, 0.2);
  background-color: var(--ag-range-selection-background-color, rgba(33, 150, 243, 0.2));
}
.ag-theme-alpine-fusion .ag-cell-range-selected:not(.ag-cell-focus).ag-cell-range-chart,
.ag-theme-alpine-fusion .ag-body-viewport:not(.ag-has-focus) .ag-cell-range-single-cell:not(.ag-cell-inline-editing).ag-cell-range-chart {
  background-color: rgba(0, 88, 255, 0.1) !important;
  background-color: var(--ag-range-selection-chart-background-color, rgba(0, 88, 255, 0.1)) !important;
}
.ag-theme-alpine-fusion .ag-cell-range-selected:not(.ag-cell-focus).ag-cell-range-chart.ag-cell-range-chart-category,
.ag-theme-alpine-fusion .ag-body-viewport:not(.ag-has-focus) .ag-cell-range-single-cell:not(.ag-cell-inline-editing).ag-cell-range-chart.ag-cell-range-chart-category {
  background-color: rgba(0, 255, 132, 0.1) !important;
  background-color: var(--ag-range-selection-chart-category-background-color, rgba(0, 255, 132, 0.1)) !important;
}
.ag-theme-alpine-fusion .ag-cell-range-selected-1:not(.ag-cell-focus),
.ag-theme-alpine-fusion .ag-root:not(.ag-context-menu-open) .ag-body-viewport:not(.ag-has-focus) .ag-cell-range-selected-1:not(.ag-cell-inline-editing) {
  background-color: rgba(33, 150, 243, 0.2);
  background-color: var(--ag-range-selection-background-color-1, var(--ag-range-selection-background-color, rgba(33, 150, 243, 0.2)));
}
.ag-theme-alpine-fusion .ag-cell-range-selected-2:not(.ag-cell-focus),
.ag-theme-alpine-fusion .ag-body-viewport:not(.ag-has-focus) .ag-cell-range-selected-2 {
  background-color: rgba(33, 150, 243, 0.36);
  background-color: var(--ag-range-selection-background-color-2, rgba(33, 150, 243, 0.36));
}
.ag-theme-alpine-fusion .ag-cell-range-selected-3:not(.ag-cell-focus),
.ag-theme-alpine-fusion .ag-body-viewport:not(.ag-has-focus) .ag-cell-range-selected-3 {
  background-color: rgba(33, 150, 243, 0.488);
  background-color: var(--ag-range-selection-background-color-3, rgba(33, 150, 243, 0.488));
}
.ag-theme-alpine-fusion .ag-cell-range-selected-4:not(.ag-cell-focus),
.ag-theme-alpine-fusion .ag-body-viewport:not(.ag-has-focus) .ag-cell-range-selected-4 {
  background-color: rgba(33, 150, 243, 0.5904);
  background-color: var(--ag-range-selection-background-color-4, rgba(33, 150, 243, 0.5904));
}
...
.ag-theme-alpine-fusion .ag-ltr .ag-has-focus .ag-cell-focus:not(.ag-cell-range-selected),
.ag-theme-alpine-fusion .ag-ltr .ag-context-menu-open .ag-cell-focus:not(.ag-cell-range-selected),
.ag-theme-alpine-fusion .ag-ltr .ag-has-focus .ag-full-width-row.ag-row-focus .ag-cell-wrapper.ag-row-group,
.ag-theme-alpine-fusion .ag-ltr .ag-cell-range-single-cell,
.ag-theme-alpine-fusion .ag-ltr .ag-cell-range-single-cell.ag-cell-range-handle, .ag-theme-alpine-fusion .ag-rtl .ag-has-focus .ag-cell-focus:not(.ag-cell-range-selected),
.ag-theme-alpine-fusion .ag-rtl .ag-context-menu-open .ag-cell-focus:not(.ag-cell-range-selected),
.ag-theme-alpine-fusion .ag-rtl .ag-has-focus .ag-full-width-row.ag-row-focus .ag-cell-wrapper.ag-row-group,
.ag-theme-alpine-fusion .ag-rtl .ag-cell-range-single-cell,
.ag-theme-alpine-fusion .ag-rtl .ag-cell-range-single-cell.ag-cell-range-handle {
  border: 1px solid;
  border-color: #2196f3;
  border-color: var(--ag-range-selection-border-color, #2196f3);
  outline: initial;
}
.ag-theme-alpine-fusion .ag-cell.ag-selection-fill-top,
.ag-theme-alpine-fusion .ag-cell.ag-selection-fill-top.ag-cell-range-selected {
  border-top: 1px dashed;
  border-top-color: #2196f3;
  border-top-color: var(--ag-range-selection-border-color, #2196f3);
}
...
.ag-theme-alpine-fusion .ag-cell.ag-selection-fill-bottom,
.ag-theme-alpine-fusion .ag-cell.ag-selection-fill-bottom.ag-cell-range-selected {
  border-bottom: 1px dashed;
  border-bottom-color: #2196f3;
  border-bottom-color: var(--ag-range-selection-border-color, #2196f3);
}
...
.ag-theme-alpine-fusion .ag-ltr .ag-side-bar-left,
.ag-theme-alpine-fusion .ag-rtl .ag-side-bar-right {
  border-right: solid 1px;
  border-right-color: #babfc7;
  border-right-color: var(--ag-border-color, #babfc7);
}
.ag-theme-alpine-fusion .ag-ltr .ag-side-bar-left .ag-tool-panel-wrapper,
.ag-theme-alpine-fusion .ag-rtl .ag-side-bar-right .ag-tool-panel-wrapper {
  border-left: solid 1px;
  border-left-color: #babfc7;
  border-left-color: var(--ag-border-color, #babfc7);
}
.ag-theme-alpine-fusion .ag-ltr .ag-side-bar-left .ag-side-button-button,
.ag-theme-alpine-fusion .ag-rtl .ag-side-bar-right .ag-side-button-button {
  border-right: 2px solid transparent;
  transition: border-right 0.3s;
}
.ag-theme-alpine-fusion .ag-ltr .ag-side-bar-left .ag-selected .ag-side-button-button,
.ag-theme-alpine-fusion .ag-rtl .ag-side-bar-right .ag-selected .ag-side-button-button {
  border-right-color: #2196f3;
  border-right-color: var(--ag-selected-tab-underline-color, var(--ag-alpine-active-color, #2196f3));
}
.ag-theme-alpine-fusion .ag-rtl .ag-side-bar-left,
.ag-theme-alpine-fusion .ag-ltr .ag-side-bar-right {
  border-left: solid 1px;
  border-left-color: #babfc7;
  border-left-color: var(--ag-border-color, #babfc7);
}
.ag-theme-alpine-fusion .ag-rtl .ag-side-bar-left .ag-tool-panel-wrapper,
.ag-theme-alpine-fusion .ag-ltr .ag-side-bar-right .ag-tool-panel-wrapper {
  border-right: solid 1px;
  border-right-color: #babfc7;
  border-right-color: var(--ag-border-color, #babfc7);
}
.ag-theme-alpine-fusion .ag-rtl .ag-side-bar-left .ag-side-button-button,
.ag-theme-alpine-fusion .ag-ltr .ag-side-bar-right .ag-side-button-button {
  border-left: 2px solid transparent;
  transition: border-left 0.3s;
}
.ag-theme-alpine-fusion .ag-rtl .ag-side-bar-left .ag-selected .ag-side-button-button,
.ag-theme-alpine-fusion .ag-ltr .ag-side-bar-right .ag-selected .ag-side-button-button {
  border-left-color: #2196f3;
  border-left-color: var(--ag-selected-tab-underline-color, var(--ag-alpine-active-color, #2196f3));
}
...
.ag-theme-alpine-fusion .ag-column-group-icons,
.ag-theme-alpine-fusion .ag-column-select-header-icon {
  color: #181d1f;
  color: var(--ag-secondary-foreground-color, var(--ag-foreground-color, #181d1f));
}
...
.ag-theme-alpine-fusion .ag-header-cell,
.ag-theme-alpine-fusion .ag-header-group-cell {
  padding-left: 18px;
  padding-right: 18px;
}
.ag-theme-alpine-fusion .ag-header-cell.ag-header-cell-moving,
.ag-theme-alpine-fusion .ag-header-group-cell.ag-header-cell-moving {
  background-color: #fff;
  background-color: var(--ag-header-cell-moving-background-color, var(--ag-background-color, #fff));
}
...
.ag-theme-alpine-fusion .ag-header-row:not(:first-child) .ag-header-cell,
.ag-theme-alpine-fusion .ag-header-row:not(:first-child) .ag-header-group-cell.ag-header-group-cell-with-group {
  border-top: solid 1px;
  border-top-color: #babfc7;
  border-top-color: var(--ag-border-color, #babfc7);
}
...
.ag-theme-alpine-fusion .ag-charts-settings-group-title-bar,
.ag-theme-alpine-fusion .ag-charts-data-group-title-bar,
.ag-theme-alpine-fusion .ag-charts-format-top-level-group-title-bar {
  border-top: solid 1px;
  border-top-color: #dde2eb;
  border-top-color: var(--ag-secondary-border-color, #dde2eb);
}
...
.ag-theme-alpine-fusion .ag-chart-data-section,
.ag-theme-alpine-fusion .ag-chart-format-section {
  display: flex;
  margin: 0;
}
...
.ag-theme-alpine-fusion .ag-status-bar,
.ag-theme-alpine-fusion .ag-header-row,
.ag-theme-alpine-fusion .ag-panel-title-bar-title,
.ag-theme-alpine-fusion .ag-multi-filter-group-title-bar {
  font-weight: 700;
  color: #181d1f;
  color: var(--ag-header-foreground-color, var(--ag-secondary-foreground-color, var(--ag-foreground-color, #181d1f)));
...
.ag-theme-alpine-fusion .ag-theme-alpine textarea[class^=ag-],
.ag-theme-alpine .ag-theme-alpine-fusion textarea[class^=ag-], .ag-theme-alpine-fusion input[class^=ag-]:not([type]),
.ag-theme-alpine-fusion input[class^=ag-][type=text],
.ag-theme-alpine-fusion input[class^=ag-][type=number],
.ag-theme-alpine-fusion input[class^=ag-][type=tel],
.ag-theme-alpine-fusion input[class^=ag-][type=date],
...
.ag-theme-alpine-fusion .ag-ltr input[class^=ag-]:not([type]),
.ag-theme-alpine-fusion .ag-ltr input[class^=ag-][type=text],
.ag-theme-alpine-fusion .ag-ltr input[class^=ag-][type=number],
.ag-theme-alpine-fusion .ag-ltr input[class^=ag-][type=tel],
.ag-theme-alpine-fusion .ag-ltr input[class^=ag-][type=date],
.ag-theme-alpine-fusion .ag-ltr input[class^=ag-][type=datetime-local],
.ag-theme-alpine-fusion .ag-ltr textarea[class^=ag-] {
  padding-left: 6px;
}

.ag-theme-alpine-fusion .ag-rtl input[class^=ag-]:not([type]),
.ag-theme-alpine-fusion .ag-rtl input[class^=ag-][type=text],
.ag-theme-alpine-fusion .ag-rtl input[class^=ag-][type=number],
.ag-theme-alpine-fusion .ag-rtl input[class^=ag-][type=tel],
.ag-theme-alpine-fusion .ag-rtl input[class^=ag-][type=date],
.ag-theme-alpine-fusion .ag-rtl input[class^=ag-][type=datetime-local],
.ag-theme-alpine-fusion .ag-rtl textarea[class^=ag-] {
  padding-right: 6px;
}
...
.ag-theme-alpine-fusion .ag-header-cell-menu-button:hover,
.ag-theme-alpine-fusion .ag-side-button-button:hover,
.ag-theme-alpine-fusion .ag-tab:hover,
.ag-theme-alpine-fusion .ag-panel-title-bar-button:hover,
.ag-theme-alpine-fusion .ag-header-expand-icon:hover,
.ag-theme-alpine-fusion .ag-column-group-icons:hover,
.ag-theme-alpine-fusion .ag-group-expanded .ag-icon:hover,
.ag-theme-alpine-fusion .ag-group-contracted .ag-icon:hover,
.ag-theme-alpine-fusion .ag-chart-settings-prev:hover,
.ag-theme-alpine-fusion .ag-chart-settings-next:hover,
.ag-theme-alpine-fusion .ag-group-title-bar-icon:hover,
.ag-theme-alpine-fusion .ag-column-select-header-icon:hover,
.ag-theme-alpine-fusion .ag-floating-filter-button-button:hover,
.ag-theme-alpine-fusion .ag-filter-toolpanel-expand:hover,
.ag-theme-alpine-fusion .ag-chart-menu-icon:hover {
  color: #2196f3;
  color: var(--ag-alpine-active-color, #2196f3);
}
