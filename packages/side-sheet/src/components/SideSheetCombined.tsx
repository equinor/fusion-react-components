...
export const SideSheetCombined = (props: PropsWithChildren<PortalSideSheet>) => {
...
SideSheetCombined.Title = Title;
SideSheetCombined.SubTitle = SubTitle;
SideSheetCombined.Indicator = Indicator;
SideSheetCombined.Content = Content;
SideSheetCombined.Actions = Actions;

export default SideSheetCombined;
