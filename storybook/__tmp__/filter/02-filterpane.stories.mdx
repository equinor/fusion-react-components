...
import { FilterProvider, CheckboxFilter, RadioFilter, GeneralBar, FilterSection } from '@equinor/fusion-react-filter';
...
<Meta
  title="Data/Filter/Filter Panel"
  parameters={{
    viewMode: 'docs',
  }}
/>
...
<Story name="Filter Panel" args={{ amount: 12 }}>
  {Pane}
</Story>
