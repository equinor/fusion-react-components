  ...
  initialResult: [
    singleItem({
      ...
      children: [
        ...
        singleItem({ id: '012', title: 'Initial Item 5', graphic: 'add', graphicType: IconType.EDS, isDisabled: true }),
        singleItem({
          id: '123',
          title: 'Initial Item 6',
          graphic: 'close_circle_outlined',
          graphicType: IconType.EDS,
          isError: true,
        }),
      ],
    }),
