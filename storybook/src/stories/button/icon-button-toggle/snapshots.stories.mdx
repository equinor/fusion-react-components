...
import readme from '@equinor/fusion-react-button/README.icon-button-toggle.md';
import { IconButtonToggle, iconNames } from '@equinor/fusion-react-button/src/icon-button-toggle';

export const Template = ({ children, ...props }) => {
  return (
    <IconButtonToggle {...props}>{children}</IconButtonToggle>
  );
};
...
<Meta
  title="Snapshots/Button/Icon Toggle"
...
<Canvas>
  <Story name="Custom Icon">
    <div style={{ display: 'flex', gap: '20px', alignItems: 'center' }}>
      <IconButtonToggle offColor="warning" onColor="secondary" size="large" rounded on>
      ...
      <IconButtonToggle offColor="primary" size="large" rounded>
...
<Canvas>
  <Story name="Custom Image">
    <IconButtonToggle offColor="disabled" onColor="warning" size="x-large" rounded>
