...
<Meta title="Person/AgGrid Cell/Docs" />
...
This component is used to render a person's details within an AgGrid cell. The cell displays a [Person Table Cell](./?path=/docs/person-docs--docs#basic-3) component, and when hovered, a tooltip provides additional information about the person in the form of [Person Card](./?path=/docs/person-docs--docs#basic-1) component.
...
const columnDefs = useMemo(() => [
  ...
  agGridPersonCell({
    ...agPersonCellData,
    field: 'driver',
    upn: (data) => data.personInfo.upn, // Access UPN from nested object
