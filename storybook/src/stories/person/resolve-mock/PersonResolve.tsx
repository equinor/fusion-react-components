import { PersonAccountType, PersonDetails, PersonResolver, PersonInfo, PersonSearchResult } from "@equinor/fusion-react-person";
...
export const createResolve: PersonResolver = {
    ...
    getPhoto: (args) =>
        Promise.resolve((getUsers(args) as PersonPicture).pictureSrc),
