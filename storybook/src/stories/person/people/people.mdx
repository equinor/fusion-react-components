...
| `systemAccounts` | `boolean` | Whether to include system accounts in the search results. Defaults to `false`. |
...
| `noResultTitle` | `string` | Custom title to display when no results are found. |
| `noResultSubtitle` | `string` | Custom subtitle to display when no results are found. |
