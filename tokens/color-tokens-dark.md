...
| `--eds-color-text-neutral-subtle` | `#d6e3ee` |
| `--eds-color-text-neutral-strong` | `#f5fdff` |
| `--eds-color-text-neutral-subtle-on-emphasis` | `#333639` |
| `--eds-color-text-neutral-strong-on-emphasis` | `#030303` |
| `--eds-color-text-accent-subtle` | `#bcebf1` |
| `--eds-color-text-accent-strong` | `#e6ffff` |
| `--eds-color-text-accent-subtle-on-emphasis` | `#2c3839` |
| `--eds-color-text-accent-strong-on-emphasis` | `#030303` |
| `--eds-color-text-success-subtle` | `#bcf2b8` |
| `--eds-color-text-success-strong` | `#e6ffe3` |
| `--eds-color-text-success-subtle-on-emphasis` | `#2c392b` |
| `--eds-color-text-success-strong-on-emphasis` | `#030303` |
| `--eds-color-text-info-subtle` | `#b7e8ff` |
| `--eds-color-text-info-strong` | `#ecffff` |
| `--eds-color-text-info-subtle-on-emphasis` | `#2a3741` |
| `--eds-color-text-info-strong-on-emphasis` | `#030304` |
| `--eds-color-text-warning-subtle` | `#ffd4aa` |
| `--eds-color-text-warning-strong` | `#fff7e6` |
| `--eds-color-text-warning-subtle-on-emphasis` | `#413226` |
| `--eds-color-text-warning-strong-on-emphasis` | `#040303` |
| `--eds-color-text-danger-subtle` | `#ffd0ce` |
| `--eds-color-text-danger-strong` | `#fff5f4` |
| `--eds-color-text-danger-subtle-on-emphasis` | `#492d2c` |
| `--eds-color-text-danger-strong-on-emphasis` | `#040303` |
